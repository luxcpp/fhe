//==================================================================================
// GPU TFHE - Massively Parallel TFHE for Large-Scale Deployments
//
...
//==================================================================================
// GPU TFHE Engine - Main interface
//==================================================================================

class GPUTFHEEngine {
public:
    explicit GPUTFHEEngine(const TFHEConfig& config = TFHEConfig());
    ~GPUTFHEEngine();
...
public:
    explicit BatchPBSScheduler(GPUTFHEEngine* engine);
...
public:
    GPUCircuitEvaluator(GPUTFHEEngine* engine, uint64_t userId);
