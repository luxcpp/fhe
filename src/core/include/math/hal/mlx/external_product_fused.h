...
#ifndef LBCRYPTO_MATH_HAL_MLX_EXTERNAL_PRODUCT_FUSED_H
#define LBCRYPTO_MATH_HAL_MLX_EXTERNAL_PRODUCT_FUSED_H
...
#endif // LBCRYPTO_MATH_HAL_MLX_EXTERNAL_PRODUCT_FUSED_H
